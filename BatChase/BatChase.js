...
if (ENVIRONMENT_IS_NODE) {
  var fs = require('fs');
  Module['wasm'] = fs.readFileSync(__dirname + '/BatChase.wasm');
}
...
var ASM_CONSTS = {
  68556: () => { document.body.style = 'margin: 0px; overflow: hidden; background: #787878;' },  
 68632: () => { document.querySelector('canvas').style['imageRendering'] = 'pixelated' },  
 68703: () => { return window.innerWidth },  
 68728: () => { return window.innerHeight }
};
...
// end include: preamble_minimal.js
  ...
  var _loadedFonts = {};
  function _load_font(fontId, url) {
  ...
  function _upload_unicode_char_to_texture(fontId, unicodeChar, fontSize) {
